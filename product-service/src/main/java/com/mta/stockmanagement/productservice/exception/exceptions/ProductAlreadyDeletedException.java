package com.mta.stockmanagement.productservice.exception.exceptions;

import com.mta.stockmanagement.productservice.enums.Language;
import com.mta.stockmanagement.productservice.exception.enums.IFriendlyMessageCode;
...
public class ProductAlreadyDeletedException extends RuntimeException{
    ...
    public ProductAlreadyDeletedException(Language language, IFriendlyMessageCode friendlyMessageCode, String message) {
        ...
        log.error("[ProductAlreadyDeletedException] -> message: {} developer message: {}",
